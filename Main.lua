...
print("Thank you for using Shadehub")
print("Made by Shade https://www.youtube.com/channel/UCNDObyaH23TwYZeRYRtOCSw")
...
local GameList = game:HttpGet('https://raw.githubusercontent.com/xor123x/SH/main/GameList.json')
function GetGame()
